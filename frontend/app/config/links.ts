...
export const LINKS = {
  ...
  certifications: {
    terraform:
      "https://www.credly.com/badges/6fb9f186-725a-42be-a6bb-72675d7e4429",
    ...
    awsCloud:
      "https://www.credly.com/badges/4a1bbee5-cb68-4641-8ed0-edd6ac2e7fd8",
  },
  ...
  api: {
    visitorCount:
      ...
      "https://nh0uf66oog.execute-api.us-east-1.amazonaws.com/prod",
  },
